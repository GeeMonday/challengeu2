...
(1..64).each do |square_num|
  grains_on_square = Grains.square(square_num)
  puts "Square #{square_num}: #{grains_on_square} grains"
end

total_grains = Grains.total
puts "Total number of grains on the chessboard: #{total_grains}"
